# 📖 Grundläggande Frontend-programmering (40 YH-poäng)
...
* **Koda lokalt:** Skapa egna mappar och filer i VS Code på din dator när du gör övningarna. Du versionshanterar din egen kod i dina egna repon.
...
* 🟡 **Missade passet / Sjuk:** Gör hela kedjan i nummerordning: **`01` $\rightarrow$ `02` $\rightarrow$ `03` $\rightarrow$ `04` $\rightarrow$ `05`**.
...
* **Starta alltid i veckomappen:** Öppna aktuell veckomapp (t.ex. `vecka-35/`) och följ veckans egen README för detaljerat dagsschema.
...
* **Vecka 38 — JavaScript-grunder & React-intro** *(Publiceras fre 11/9)*
...
* **Fullt ägarskap:** Du ska förstå varje rad du lämnar in och kunna förklara den muntligt vid examination.
